...
public class CoinsIndexListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
	...
	private static CoinsIndexListener instance = null;
    ...
    public static CoinsIndexListener Instance
    {
		get
		{
            // Debug.Log(instance);
	...
	void Start()
	{
        ...
        gestureInfo = canvasObj.GetComponentInChildren<Text>();
    }
