...
public class CubeAllScript : MonoBehaviour
{
    ...
    // private Cube1GestureListener gestureListener;
    ...
    void Start()
    {
        ...
        // gestureListener = Cube1GestureListener.Instance;
        gestureListener = CubeAllGestureListener.Instance;
        Debug.Log("CAScript Test:" + cubeId + gestureListener);      // gestureListener = CubeAllGestureListener
    }
