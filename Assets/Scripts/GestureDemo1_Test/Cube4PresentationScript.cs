...
public class Cube4PresentationScript : MonoBehaviour 
{
    ...
    // private Cube4GestureListener gestureListener;
	...
	void Start() 
	{
        ...
        // gestureListener = Cube4GestureListener.Instance;
        gestureListener = CubeAllGestureListener.Instance;
        Debug.Log("Test 4:" + gestureListener);
    }
