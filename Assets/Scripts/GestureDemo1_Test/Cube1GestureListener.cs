...
public class Cube1GestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
	...
	private static Cube1GestureListener instance = null;
	...
	public static Cube1GestureListener Instance
    {
		get
		{
			// Debug.Log(instance);
