...
public class Cube4GestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
	...
	private static Cube4GestureListener instance = null;
	...
	public static Cube4GestureListener Instance
    {
		get
		{
			// Debug.Log(instance);
