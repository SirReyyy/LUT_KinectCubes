...
public class Cube3GestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
	...
	private static Cube3GestureListener instance = null;
	...
	public static Cube3GestureListener Instance
    {
		get
		{
			// Debug.Log(instance);
