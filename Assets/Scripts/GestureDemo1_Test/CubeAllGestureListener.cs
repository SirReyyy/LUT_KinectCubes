...
public class CubeAllGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
	...
	public static CubeAllGestureListener Instance
    {
		get
		{
			// Debug.Log(instance);
	...
	public void AddInstance(string cubeId, CubeAllGestureListener listener)
	{
		for(int i = 0; i < cubeAllScriptsDict.Count; i++)
		{
	...
	void Start()
	{
		int cubeCount = cubeAllScriptsDict.Count;
		print("CAGListener Count: " + cubeCount);
    }
