...
public class Cube2GestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
	...
	private static Cube2GestureListener instance = null;
	...
	public static Cube2GestureListener Instance
    {
		get
		{
			// Debug.Log(instance);
