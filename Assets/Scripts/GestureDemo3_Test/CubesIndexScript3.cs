...
public class CubesIndexScript3 : MonoBehaviour
{
    ...
    private int cubeRowStart = 0, cubeColStart = 0;
    private int cubeRowEnd, cubeColEnd;

    private CubesIndexListener3 gestureListener;
    private CubesIndexCoordinates3 indexCoordinates;
    ...
    void Start()
    {
        ...
        {
            cubeSides.Add(child.gameObject);
        }
        ...
        gestureListener = gameObject.GetComponent<CubesIndexListener3>();
        indexCoordinates = gameObject.GetComponentInParent<CubesIndexCoordinates3>();
